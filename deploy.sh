...
show_system_info() {
    ...
    echo "========================"
    echo "🌐 URLs de acceso:"
    echo "   • Frontend Local: http://localhost:3005"
    echo "   • Backend Local:  http://localhost:8001"
    echo "   • Público:        https://bedrock-playground.danielingram.shop"
    echo "   • MCP:            https://bedrock-mcp.danielingram.shop"
    echo ""
    echo "📊 Endpoints de monitoreo:"
    echo "   • Health:         http://localhost:8001/health"
    echo "   • Security:       http://localhost:8001/security-status"
    echo "   • S3 Files:       http://localhost:8001/list-files"
    echo ""
    echo "📁 Logs:"
